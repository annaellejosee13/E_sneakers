    ...
    <div class="form-container sign-in-container">
      <form @submit.prevent>
        ...
        <a href="#">Mot de passe oublier?</a>
          <button type="button" id="loginBtn" @click="handleLogin">Se connecter</button>
      </form>
    </div>
    <div class="overlay-container">
      <div class="overlay">
        <div class="overlay-panel overlay-left">
          ...
          <p>Avec Skeankers – Marchez avec style, chaque pas devient une déclaration de mode</p>
            <button class="ghost" id="signIn" @click="isSignUp = false">Se connecter</button>
        </div>
        <div class="overlay-panel overlay-right">
          <h1>Salut, bienvenue</h1>
          <p>Entrez vos coordonnées personnelles et commencez votre voyage avec nous</p>
            <button class="ghost" id="signUp" @click="isSignUp = true">S'inscrire</button>
        </div>
      </div>
    </div>
  </div>
...
<style scoped>
<style>
/* Ajoute ceci dans le <head> de index.html :
